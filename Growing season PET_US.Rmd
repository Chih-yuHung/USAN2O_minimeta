...
sum(PET.avg$Avg_PET >=800) #53 counties over 3104 couties
```
...
PET.sum("Tippecanoe","Indiana", 2011, 2011) #635
...
PET.sum("Faribault","Minnesota", 2014, 2015) #625
PET.sum("Faribault","Minnesota", 1981, 2010) #631
```

```{r Graham et al., 2018}
#Urbana, Champaign, Illinois. 2015-2017
PET.sum("Champaign","Illinois", 2015, 2015) #642
PET.sum("Champaign","Illinois", 2016, 2016) #644
PET.sum("Champaign","Illinois", 2017, 2017) #652
...
PET.sum("Twin Falls","Idaho", 2013, 2013) #737
PET.sum("Twin Falls","Idaho", 2014, 2014) #740
PET.sum("Twin Falls","Idaho", 2015, 2015) #752
PET.sum("Twin Falls","Idaho", 2016, 2016) #737
PET.sum("Twin Falls","Idaho", 1981, 2010) #732
```

```{r Li et al., 2019}
#Aurora, Brookings, South Dakota. 2014-2016
PET.sum("Brookings","South Dakota", 2014, 2014) #629
PET.sum("Brookings","South Dakota", 2015, 2015) #632
PET.sum("Brookings","South Dakota", 2016, 2016) #645
...
PET.sum("Riley","Kansas", 2013, 2013) #685
PET.sum("Riley","Kansas", 2014, 2014) #688
...
PET.sum("Dakota","Minnesota", 2011, 2011) #636
```
...
PET.sum("Tippecanoe","Indiana", 2015, 2015) #623
PET.sum("Tippecanoe","Indiana", 2016, 2016) #632
...
PET.sum("Richland","Montana", 2011, 2011) #665
...
PET.sum("Warren","Kentucky", 2011, 2011) #640
PET.sum("Warren","Kentucky", 1981, 2010) #30y avg. 644
```
```{r Snell et al., 2014}
#Mead, Saunders, Nebraska. 2011-2012
PET.sum("Saunders","Nebraska", 2011, 2011) #663
PET.sum("Saunders","Nebraska", 2012, 2012) #738
...
PET.sum("Ramsey","Minnesota", 2014, 2015)#624
...
PET.sum("Solano","California", 2010, 2011) #738
